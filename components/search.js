        ...
        return (
            <div>
                ...
                <div className="mn-social-bottom-c">
                    <a className="mn-social-bottom" title="Share on Facebook" href={"https://www.facebook.com/sharer/sharer.php?u=" + url} target="_blank">
                    ...
                    <a className="mn-social-bottom" title="Share on Twitter" href={"https://twitter.com/home?status=" + url + " " + title} target="_blank">
                    ...
                    <a className="mn-social-bottom" title="Share on Linkedin" href={"https://www.linkedin.com/shareArticle?mini=true&url=" + url} target="_blank">
                    ...
                    <a className="mn-social-bottom" title="Share on Google+" href={"https://plus.google.com/share?url=" + url} target="_blank">
                    ...
                    <a className="mn-social-bottom" title="Share on Pinterest" href={"https://pinterest.com/pin/create/link/?url=" + url} target="_blank">
